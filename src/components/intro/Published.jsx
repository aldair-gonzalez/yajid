        ...
        <div className="Published-wrapper Wrapper">
          <div className="Published-grid">
            ...
            <div className="Published-item Published-item--left">
              <img
                className="Published-img"
                src="https://images.unsplash.com/photo-1632687380457-05a1271e873b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
                alt="/"
              />
            </div>
          </div>
