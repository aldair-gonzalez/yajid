  ...
  return (
    <>
      <button
        ...
        id="Carrito"
        onClick={handleActiveDrawerClick}
      >
        <svg
          className="Header-buttonSvg Header-buttonSvg--cart"
        ...
        <div className="Drawer-content">
          <div className="Drawer-wrapper">
            <div className="Drawer-header">
              <button
                className="Drawer-backBtn"
                title="Regresar"
                onClick={handleActiveDrawerClick}
              >
                <svg
                  className="Drawer-backIcon"
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                  fill="currentColor"
            ...
            <p className="Drawer-text">
              Si tienes dudas sobre como comprar dirigete a nuestra
              <Link className="Drawer-text--a" to="/" title="Ir a como comprar">
                guía de compra
              </Link>
            </p>
            <div className="Drawer-body">
              <div className="Drawer-empty">Tu carrito esta vacio</div>
            </div>
          </div>
        </div>
      </section>
