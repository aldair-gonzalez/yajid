...
function Navbar () {
    ...
    useEffect(() => window.addEventListener('scroll', () => window.scrollY > 50 ? setScrolled(true) : setScrolled(false)), [ scrolled ]);
                ...
                <div className="Header-icons">
                    <div className="Header-wrapper Wrapper">
                        <div className="Header-icon">
                            <button className="Header-button" title="Abrir menú de navegación">
                                <svg className="Header-buttonSvg" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <h1 className="Header-logo">
                            <Link className="Header-logoLink" to="/" title="Super Yajid">
                                <img className="Header-logoImg" src={LogoPng} alt="Super Yajid"/>
                            </Link>
                        </h1>
